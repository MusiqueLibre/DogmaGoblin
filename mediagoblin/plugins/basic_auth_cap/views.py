...
from mediagoblin.plugins.basic_auth_cap import forms, tools
...
def forgot_password(request):
    ...
    if not (request.method == 'POST' and fp_form.validate()):
        ...
        return render_to_response(request,
            'mediagoblin/plugins/basic_auth_cap/forgot_password.html',
            {'fp_form': fp_form})
    ...
    if user.has_privilege(u'active'):
        ...
        if request.method == 'POST' and cp_form.validate():
            ...
            return render_to_response(
                request,
                'mediagoblin/plugins/basic_auth_cap/change_fp.html',
                {'cp_form': cp_form})
...
def change_pass(request):
    ...
    if request.method == 'POST' and form.validate():
        ...
        if not tools.bcrypt_check_password(
            ...
            return render_to_response(
                request,
                'mediagoblin/plugins/basic_auth_cap/change_pass.html',
                {'form': form,
                 'user': user})
