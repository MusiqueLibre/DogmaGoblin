...
from mediagoblin.plugins.basic_auth_cap import forms as auth_forms
from mediagoblin.plugins.basic_auth_cap import tools as auth_tools
...
def setup_plugin():
    config = pluginapi.get_config('mediagoblin.plugins.basic_auth_cap')

    routes = [
        ('mediagoblin.plugins.basic_auth_cap.edit.pass',
         '/edit/password/',
         'mediagoblin.plugins.basic_auth_cap.views:change_pass'),
        ('mediagoblin.plugins.basic_auth_cap.forgot_password',
         '/auth/forgot_password/',
         'mediagoblin.plugins.basic_auth_cap.views:forgot_password'),
        ('mediagoblin.plugins.basic_auth.verify_forgot_password',
         '/auth/forgot_password/verify/',
         'mediagoblin.plugins.basic_auth_cap.views:verify_forgot_password')]

    pluginapi.register_routes(routes)
    pluginapi.register_template_path(os.path.join(PLUGIN_DIR, 'templates'))

    pluginapi.register_template_hooks(
        {'edit_link': 'mediagoblin/plugins/basic_auth_cap/edit_link.html',
         'fp_link': 'mediagoblin/plugins/basic_auth_cap/fp_link.html',
         'fp_head': 'mediagoblin/plugins/basic_auth_cap/fp_head.html',
         'create_account':
            'mediagoblin/plugins/basic_auth_cap/create_account_link.html'})
...
hooks = {
    ...
    'static_setup': lambda: PluginStatic(
        'coreplugin_basic_auth_cap',
        resource_filename('mediagoblin.plugins.basic_auth_cap', 'static'))
}
